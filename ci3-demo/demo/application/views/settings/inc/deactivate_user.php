<!-- Stat Model --> 
<div class="modal fade  " id="deactivate_user_modal"  role="dialog">
   <div class="modal-dialog" role="document">
      <div class="modal-content">
         <div class="modal-header">
            <h4 class="modal-title" id="exampleModalLabel1">  Deactivate User  </h4>
         ...
         <div class="modal-body">
              ...
              <form  method="post" name="deactivate_user_form" id="deactivate_user_form"   >   
              <input type="hidden" readonly name="user_id_2" id="user_id_2"   required autocomplete="off" value="<?php echo $user_data['user']['id'] ?>" >
