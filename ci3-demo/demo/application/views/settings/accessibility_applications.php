...
<div class = "container" style="width:100%" >
 ...
 <title> - Applications Accessibility</title>
<div class = "row" >
                  <div class = "col"  >
                     <h3> Applications Accessibility</h3>
  ...
  <button type="button" class="btn btn-default text-dark float-right ml-2 rounded-pill" type="button" data-toggle="collapse" data-target="#collapse_2" aria-expanded="false" aria-controls="collapseExample"> <i class="fa-solid fa-bars"></i></button>
                      ...
                      <a href="<?php echo base_url('settings/accessibility_users'); ?>"  id="table_button"   class="btn btn-sm btn-secondary  rounded-pill float-right ml-2"  href="#">  <small class="fas fa-external-link-alt   "></small>&nbsp;&nbsp;  Users Accessibility &nbsp;&nbsp;    </a> 
 ...
 <tr >
   <?php if (count($app_data)): ?>
           ...
           <td><a id="table_button"   class="btn btn-sm btn-secondary  rounded-pill"  href="<?php echo base_url() . 'settings/view_accessibility_application/'.$row->id ?>">&nbsp;&nbsp;  View &nbsp;&nbsp;</a></td>
