<html>
   ...
   <li class="nav-item">
               ...
               <li class="nav-item active">
                  <a href="/invoicing" style="color: white;" class="btn btn-dark" type="submit">  
               <span class="collapsed_header">   Invoicing </span>
               </a>
               </li>
...
<li class="nav-item active dropdown">
  ...
  <div class="dropdown-menu" aria-labelledby="navbarDropdown">
          ...
          <a class="dropdown-item" href="<?php echo base_url('invoicing/new_invoice');?>">New Invoice</a>
      <div class="dropdown-divider"></div>
    
          <a class="dropdown-item" href="<?php echo base_url('invoicing/invoices');?>">All Invoices</a>
      <div class="dropdown-divider"></div>
