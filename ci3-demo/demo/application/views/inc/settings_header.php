         ...
         <div class="navbar-collapse collapse w-100 order-1 order-md-0 dual-collapse2">
            <ul class="navbar-nav mr-auto">
               ...
               <li class="nav-item active">
                  <a   href="<?php echo base_url('settings'); ?>" style="color: white;" class="btn btn-dark" type="submit" >  
               <span class="collapsed_header">   Settings </span>
               </a>
               </li>
